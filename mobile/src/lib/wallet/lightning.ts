/*
  Backend-agnostic Lightning helpers — direct port of web src/lib/wallet/lightning.ts.
  Wallet methods live on WalletAdapter; this file only holds protocol helpers
  (LNURL-pay) that aren't tied to a specific wallet backend.
*/
